...
# this file has been ported from C# extension methods to Python monkey patching

# TODO move these functions/methods directly into the Python 'class CrsProjection(enum.Enum)'
